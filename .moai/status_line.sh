...
if [ -f "/Users/truestone/go/bin/moai" ]; then
	exec "/Users/truestone/go/bin/moai" statusline < "$temp_file"
fi

# Try user local bin directory
if [ -f "/Users/truestone/.local/bin/moai" ]; then
	exec "/Users/truestone/.local/bin/moai" statusline < "$temp_file"
fi
