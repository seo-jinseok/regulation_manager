    ...
    for doc in docs:
        ...
        if "addenda" in doc and doc["addenda"]:
            ...
            for ad in doc["addenda"]:
                ...
                split_addenda, split_attached = formatter._parse_appendices(
                    simulated_text
                )
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Patch addenda and attached files in a JSON output."
    )
    parser.add_argument(
        "input_path", nargs="?", default="data/output/규정집9-343-test1.json"
    )
