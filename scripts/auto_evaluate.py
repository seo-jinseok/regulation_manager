...
from src.rag.infrastructure.feedback import FeedbackCollector, FeedbackEntry
from src.rag.application.search_usecase import SearchUseCase
from src.rag.application.evaluate import EvaluationUseCase, EvaluationResult
from src.rag.application.auto_learn import AutoLearnUseCase, AnalysisResult
...
def run_evaluation_loop(eval_usecase: EvaluationUseCase, feedback_collector: FeedbackCollector):
    ...
    for result in summary.results:
        if not result.passed:
            ...
            feedback_collector.record_feedback(
                ...
                rule_code=result.found_rule_codes[0] if result.found_rule_codes else "NONE",
                rating="negative",
