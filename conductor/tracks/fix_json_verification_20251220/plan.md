...
- [ ] Task: Analyze the uncommitted changes in `src/verify_json.py`.
...
- [ ] Task: Reproduce the verification failure.
...
- [ ] Task: Review `SCHEMA_REFERENCE.md` and `docs/schema_v2.md`.
