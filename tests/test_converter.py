...
class TestConverter(unittest.TestCase):
    ...
    @patch('builtins.open', new_callable=unittest.mock.mock_open, read_data="<html><body>Test HTML</body></html>")
    def test_load_data_success(self, mock_open, mock_tmp, mock_popen):
        ...
        with patch('pathlib.Path.exists', return_value=True):
            with patch('pathlib.Path.glob', return_value=[Path("/tmp/dir/index.xhtml")]):
